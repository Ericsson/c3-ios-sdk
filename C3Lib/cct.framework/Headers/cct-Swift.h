...
/// This method is called whenever a message that was sent with <code>RtcPeer.sendMessage(_:)</code> is received.
...
/// A utility that can be used for media switching in a <code>Conference</code>. A <code>MediaSwitcher</code> selects one conference
/// participant to be the “active speaker”. Only the stream from the active speaker will be sent and displayed.
/// version:
/// 1.0.0
/// <h4>Example</h4>
/// Example of connecting a <code>MediaSwitcher</code> to a conference
/// \code
